            ...
            if keyboard.is_pressed("space"):
                ...
                if i % 2 == 0:
                    if chance - i / 2 - 1 != 0 and chance - i / 2 - 1 != -1:
                        print(f"Now You have only {int(chance - i/2 -1)} chance")
                        engine.say(f"Now You have only {int(chance - i/2 -1)} chance")
                        engine.runAndWait()
                    elif chance - i / 2 - 1 == -1:
                        print("Good Bye")
                        engine.say("Good Bye")
...
def exam():
    os.system("cls")
    colour = [Fore.RED, Fore.BLUE, Fore.GREEN, Fore.YELLOW, Fore.CYAN, Fore.MAGENTA]
...
def FRIDAY():
    os.system("cls")
    print(
        f"{Fore.LIGHTRED_EX}Artifitial Intellegent FRIDAY created by V.Adhiban Siddarth\n"
    )
    # sleep(2)
    ...
    print(
        f"\n{Fore.RED}({Fore.MAGENTA}{c_time()}{Fore.RED}){Fore.GREEN} 'FRIDAY' {Fore.RED}$ ",
        end="",
    )
